...
declare module 'vue-router/auto-routes' {
  ...
  export interface RouteNamedMap {
    ...
    'apps-after-sales-clients-list': RouteRecordInfo<'apps-after-sales-clients-list', '/apps/after-sales/clients/list', Record<never, never>, Record<never, never>>,
    'apps-after-sales-clients-view-id': RouteRecordInfo<'apps-after-sales-clients-view-id', '/apps/after-sales/clients/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-after-sales-follow-up-list': RouteRecordInfo<'apps-after-sales-follow-up-list', '/apps/after-sales/follow-up/list', Record<never, never>, Record<never, never>>,
    'apps-after-sales-follow-up-view-id': RouteRecordInfo<'apps-after-sales-follow-up-view-id', '/apps/after-sales/follow-up/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-after-sales-technicians-list': RouteRecordInfo<'apps-after-sales-technicians-list', '/apps/after-sales/technicians/list', Record<never, never>, Record<never, never>>,
    'apps-after-sales-technicians-view-id': RouteRecordInfo<'apps-after-sales-technicians-view-id', '/apps/after-sales/technicians/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    'apps-after-sales-warranties': RouteRecordInfo<'apps-after-sales-warranties', '/apps/after-sales/warranties', Record<never, never>, Record<never, never>>,
    'apps-assignment': RouteRecordInfo<'apps-assignment', '/apps/assignment', Record<never, never>, Record<never, never>>,
    ...
    'apps-materials-new-group': RouteRecordInfo<'apps-materials-new-group', '/apps/materials/new/:group', { group: ParamValue<true> }, { group: ParamValue<false> }>,
    ...
    'apps-trends-list': RouteRecordInfo<'apps-trends-list', '/apps/trends/list', Record<never, never>, Record<never, never>>,
    'apps-trends-view-id': RouteRecordInfo<'apps-trends-view-id', '/apps/trends/view/:id', { id: ParamValue<true> }, { id: ParamValue<false> }>,
    ...
    'pages-notifications': RouteRecordInfo<'pages-notifications', '/pages/notifications', Record<never, never>, Record<never, never>>,
