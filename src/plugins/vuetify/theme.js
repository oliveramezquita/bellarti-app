export const staticPrimaryColor = '#664125'
export const staticPrimaryDarkenColor = '#482e19'
export const themes = {
  light: {
    dark: false,
    colors: {
  ...
  dark: {
    ...
    colors: {
      ...
      'skin-bordered-background': '#f7f1eb',
      'skin-bordered-surface': '#f7f1eb',
    },
    variables: {
      'code-color': '#d400ff',
