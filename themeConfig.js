...
import logo from '@images/logo-bellarti.svg?raw'
import fullLogo from '@images/svg-logo-bellarti_iso.svg?raw'
...
export const { themeConfig, layoutConfig } = defineThemeConfig({
  app: {
    ...
    fullLogo: h('div', { innerHTML: fullLogo, style: 'line-height:0; color: rgb(var(--v-global-theme-primary))' }),
